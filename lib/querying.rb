...
def select_name_and_series_subgenres_of_authors
  "SELECT authors.name, subgenres.name FROM series INNER JOIN authors 
...
def select_series_title_with_most_human_characters
  ...
  WHERE characters.species = 'human' GROUP BY characters.species ORDER BY characters.species DESC;"
end

def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(books.id) AS count FROM characters
  ...
  GROUP BY characters.name ORDER BY count DESC, characters.name;"
end
